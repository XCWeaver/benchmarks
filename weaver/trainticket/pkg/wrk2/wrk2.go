...
type server struct {
	...
	//adminBasicInfoService weaver.Ref[services.AdminBasicInfoService]
	//adminOrderService     weaver.Ref[services.AdminOrderService]
	/*adminRouteService       weaver.Ref[services.AdminRouteService]
	adminTravelService      weaver.Ref[services.AdminTravelService]*/
	//adminUserService weaver.Ref[services.AdminUserService]
	/*foodService             weaver.Ref[services.FoodService]
	routePlanService        weaver.Ref[services.RoutePlanService]
	consignService          weaver.Ref[services.ConsignService]
	voucherService          weaver.Ref[services.VoucherService]
	travelPlanService       weaver.Ref[services.TravelPlanService]
	ticketOfficeService     weaver.Ref[services.TicketOfficeService]
	insuranceService        weaver.Ref[services.InsuranceService]
	routeService            weaver.Ref[services.RouteService]
	rebookService weaver.Ref[services.RebookService]
	stationService          weaver.Ref[services.StationService]*/
	cancelService weaver.Ref[services.CancelService]
	//paymentService weaver.Ref[services.PaymentService]
	/*insidePaymentService    weaver.Ref[services.InsidePaymentService]
	notificationService     weaver.Ref[services.NotificationService]
	basicService            weaver.Ref[services.BasicService]
	ticketInfoService       weaver.Ref[services.TicketInfoService]
	...
	//authService weaver.Ref[services.AuthService]
	/*verificationCodeService weaver.Ref[services.VerificationCodeService]
	travel2Service          weaver.Ref[services.Travel2Service]
	travelService           weaver.Ref[services.TravelService]
	executeService          weaver.Ref[services.ExecuteService]
	securityService         weaver.Ref[services.SecurityService]
	configService           weaver.Ref[services.ConfigService]*/
