...
type AdminBasicInfoService interface {
	...
	AddContacts(ctx context.Context, contact util.Contact, token string) (util.Contact, error)
	...
	GetAllTrains(ctx context.Context, token string) ([]util.Train, error)
	DeleteTrain(ctx context.Context, trainId string, token string) (string, error)
	ModifyTrain(ctx context.Context, train util.Train, token string) (util.Train, error)
	AddTrain(ctx context.Context, train util.Train, token string) (util.Train, error)
	...
	AddPrice(ctx context.Context, pc util.PriceConfig, token string) (util.PriceConfig, error)
	//* Token-less
...
type adminBasicInfoService struct {
	weaver.Implements[AdminBasicInfoService]
...
func (abis *adminBasicInfoService) GetAllContacts(ctx context.Context, token string) ([]util.Contact, error) {
...
func (abis *adminBasicInfoService) ModifyContacts(ctx context.Context, contact util.Contact, token string) (util.Contact, error) {
...
func (abis *adminBasicInfoService) AddContacts(ctx context.Context, contact util.Contact, token string) (util.Contact, error) {
...
func (abis *adminBasicInfoService) GetAllStations(ctx context.Context, token string) ([]util.Station, error) {
...
func (abis *adminBasicInfoService) DeleteStation(ctx context.Context, station util.Station, token string) (string, error) {
...
func (abis *adminBasicInfoService) GetAllTrains(ctx context.Context, token string) ([]util.Train, error) {
...
func (abis *adminBasicInfoService) ModifyTrain(ctx context.Context, train util.Train, token string) (util.Train, error) {
...
func (abis *adminBasicInfoService) AddTrain(ctx context.Context, train util.Train, token string) (util.Train, error) {
...
func (abis *adminBasicInfoService) GetAllPrices(ctx context.Context, token string) ([]util.PriceConfig, error) {
...
func (abis *adminBasicInfoService) DeletePrice(ctx context.Context, pc util.PriceConfig, token string) (string, error) {
...
func (abis *adminBasicInfoService) ModifyPrice(ctx context.Context, pc util.PriceConfig, token string) (util.PriceConfig, error) {
...
func (abis *adminBasicInfoService) AddPrice(ctx context.Context, pc util.PriceConfig, token string) (util.PriceConfig, error) {
...
func (abis *adminBasicInfoService) GetAllConfigs(ctx context.Context, token string) ([]util.Config, error) {
...
func (abis *adminBasicInfoService) ModifyConfig(ctx context.Context, config util.Config, token string) (util.Config, error) {
...
func (abis *adminBasicInfoService) AddConfig(ctx context.Context, config util.Config, token string) (util.Config, error) {
