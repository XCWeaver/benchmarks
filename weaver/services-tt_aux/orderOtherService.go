...
type orderOtherService struct {
	weaver.Implements[OrderOtherService]
	db             components.NoSQLDatabase
	stationService weaver.Ref[StationService]
	roles          []string
}

func (osi *orderOtherService) GetTicketListByDateAndTripId(ctx context.Context, travelDate, trainNumber, token string) ([]util.Ticket, error) {
...
func (osi *orderOtherService) CreateNewOrder(ctx context.Context, order util.Order, token string) (util.Order, error) {
...
func (osi *orderOtherService) AddCreateNewOrder(ctx context.Context, order util.Order, token string) (util.Order, error) {
...
func (osi *orderOtherService) QueryOrders(ctx context.Context, orderInfo util.OrderInfo, accountId, token string) ([]util.Order, error) {
	err := util.Authenticate(token, osi.roles...)
	if err != nil {
		return nil, err
	}
...
func (osi *orderOtherService) QueryOrdersForRefresh(ctx context.Context, orderInfo util.OrderInfo, accountId, token string) ([]util.Order, error) {
	err := util.Authenticate(token, osi.roles...)
	if err != nil {
		return nil, err
	}
...
func (osi *orderOtherService) CalculateSoldTicket(ctx context.Context, travelDate, trainNumber, token string) (util.SoldTicket, error) {
	err := util.Authenticate(token)
	if err != nil {
...
func (osi *orderOtherService) PayOrder(ctx context.Context, orderId, token string) (util.Order, error) {
	err := util.Authenticate(token)
	if err != nil {
		return util.Order{}, err
	}
...
func (osi *orderOtherService) GetOrderById(ctx context.Context, orderId, token string) (util.Order, error) {
	err := util.Authenticate(token)
	if err != nil {
		return util.Order{}, err
	}
...
func (osi *orderOtherService) ModifyOrder(ctx context.Context, orderId string, status uint16, token string) (util.Order, error) {
	err := util.Authenticate(token, osi.roles...)
	if err != nil {
		return util.Order{}, err
	}
...
func (osi *orderOtherService) SaveOrderInfo(ctx context.Context, order util.Order, token string) (util.Order, error) {
	err := util.Authenticate(token, osi.roles...)
	if err != nil {
		return util.Order{}, err
	}
...
func (osi *orderOtherService) UpdateOrder(ctx context.Context, order util.Order, token string) (util.Order, error) {
	err := util.Authenticate(token, osi.roles[0])
	if err != nil {
		return util.Order{}, err
	}
...
func (osi *orderOtherService) FindAllOrder(ctx context.Context, token string) ([]util.Order, error) {
	err := util.Authenticate(token)
	if err != nil {
		return nil, err
	}
