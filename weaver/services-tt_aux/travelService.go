...
func (tsi *travelService) GetTrainTypeByTripId(ctx context.Context, tripId, token string) (util.Train, error) {
...
func (tsi *travelService) GetRouteByTripId(ctx context.Context, tripId, token string) (util.Route, error) {
	err := util.Authenticate(token)
	if err != nil {
...
func (tsi *travelService) GetTripsByRouteId(ctx context.Context, routeIds []string, token string) ([]util.Trip, error) {
...
func (tsi *travelService) UpdateTrip(ctx context.Context, trip util.Trip, token string) (util.Trip, error) {
...
func (tsi *travelService) Retrieve(ctx context.Context, tripId string, token string) (util.Trip, error) {
	err := util.Authenticate(token)
	if err != nil {
		return util.Trip{}, err
	}
...
func (tsi *travelService) CreateTrip(ctx context.Context, trip util.Trip, token string) (util.Trip, error) {
	err := util.Authenticate(token)
	if err != nil {
		return util.Trip{}, err
	}
...
func (tsi *travelService) DeleteTrip(ctx context.Context, tripId string, token string) (string, error) {
	err := util.Authenticate(token, tsi.roles[0])
	if err != nil {
		return "", err
	}
...
func (tsi *travelService) QueryInfo(ctx context.Context, startingPlace, endPlace, departureTime, token string) ([]util.TripDetails, error) {
	err := util.Authenticate(token)
	if err != nil {
		return nil, err
	}
...
func (tsi *travelService) GetTripAllDetailInfo(ctx context.Context, id, from, to, travelDate, token string) (util.Trip, util.TripDetails, error) {
	err := util.Authenticate(token)
	if err != nil {
...
func (tsi *travelService) QueryAll(ctx context.Context, token string) ([]util.Trip, error) {
	err := util.Authenticate(token)
	if err != nil {
		return nil, err
	}
...
func (tsi *travelService) AdminQueryAll(ctx context.Context, token string) ([]util.Trip, []util.Train, []util.Route, error) {
	err := util.Authenticate(token, tsi.roles[0])
	if err != nil {
...
func (tsi *travelService) GetTickets(ctx context.Context, trip util.Trip, route util.Route, startingPlaceId, endPlaceId, startingPlaceName, endPlaceName, departureTime, token string) (util.TripDetails, error) {
	...
	soldTicket, err := tsi.orderService.Get().CalculateSoldTicket(ctx, departureTime, trip.TrainTypeId+trip.Number, token)
	if err != nil {
		return util.TripDetails{}, err
	}
