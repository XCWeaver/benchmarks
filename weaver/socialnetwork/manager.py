...
def metrics(deployment, timestamp=None):
  ...
  consistency_window_median_ms = "{:.2f}".format(consistency_window_median_ms) if consistency_window_median_ms != None else 0
  ...
  results = {
    ...
    'pc_received_notifications': float(pc_received_notifications),
...
def gcp_configure():
  ...
  try:
    ...
    # udp ports: 4789,7946
    firewalls = {
      'weaver-dsb-socialnetwork': 'tcp:12345,tcp:14318', 
...
if __name__ == "__main__":
  ...
  commands = [
    ...
    # eval
    'init-social-graph', 'wrk2', 'wrk2-vm', 'metrics', 'metrics-eu', 'metrics-us',
  ]
  for cmd in commands:
