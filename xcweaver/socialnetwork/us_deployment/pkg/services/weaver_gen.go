...
func init() {
	...
	codegen.Register(codegen.Registration{
		...
		AntipodeAgents: []string{"mongoClientUpdateHomeTL", "rabbitClientUpdateHomeTL"},
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
		...
		RefData: "⟦9dcf5ded:wEaVeRaNtIpOdEaGeNtS:us_deployment/pkg/services/UpdateHomeTimelineService→mongoClientUpdateHomeTL,rabbitClientUpdateHomeTL⟧\n",
	})
	codegen.Register(codegen.Registration{
...
var _ xcweaver.Unrouted = (*updateHomeTimelineService)(nil)
