...
func (x *Post) WeaverMarshal(enc *codegen.Encoder) {
	...
	enc.String(x.Text)
	serviceweaver_enc_slice_UserMention_fb574b51(enc, x.UserMentions)
	serviceweaver_enc_slice_Media_fb46f2c9(enc, x.Media)
	serviceweaver_enc_slice_URL_4a6e9247(enc, x.URLs)
	enc.Int64(x.Timestamp)
...
func (x *Post) WeaverUnmarshal(dec *codegen.Decoder) {
	...
	x.Text = dec.String()
	x.UserMentions = serviceweaver_dec_slice_UserMention_fb574b51(dec)
	x.Media = serviceweaver_dec_slice_Media_fb46f2c9(dec)
	x.URLs = serviceweaver_dec_slice_URL_4a6e9247(dec)
	x.Timestamp = dec.Int64()
	*(*int)(&x.PostType) = dec.Int()
}

func serviceweaver_enc_slice_UserMention_fb574b51(enc *codegen.Encoder, arg []UserMention) {
	if arg == nil {
		enc.Len(-1)
		return
	}
...
func serviceweaver_dec_slice_UserMention_fb574b51(dec *codegen.Decoder) []UserMention {
	n := dec.Len()
	if n == -1 {
		return nil
	}
...
func serviceweaver_enc_slice_Media_fb46f2c9(enc *codegen.Encoder, arg []Media) {
	if arg == nil {
		enc.Len(-1)
		return
	}
...
func serviceweaver_dec_slice_Media_fb46f2c9(dec *codegen.Decoder) []Media {
	n := dec.Len()
	if n == -1 {
		return nil
	}
...
func serviceweaver_enc_slice_URL_4a6e9247(enc *codegen.Encoder, arg []URL) {
	if arg == nil {
		enc.Len(-1)
		return
	}
...
func serviceweaver_dec_slice_URL_4a6e9247(dec *codegen.Decoder) []URL {
	n := dec.Len()
	if n == -1 {
		return nil
	}
