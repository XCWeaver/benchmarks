...
func init() {
	codegen.Register(codegen.Registration{
		...
		RefData: "⟦c45426f5:wEaVeReDgE:github.com/XCWeaver/xcweaver/Main→eu-deployment/PostUpload⟧\n⟦b0383eb4:wEaVeRlIsTeNeRs:github.com/XCWeaver/xcweaver/Main→postnot⟧\n",
	})
	codegen.Register(codegen.Registration{
		...
		RefData: "⟦bdf3c429:wEaVeRaNtIpOdEaGeNtS:eu-deployment/Notifier→clientRabbitMQ⟧\n",
	})
	codegen.Register(codegen.Registration{
		...
		RefData: "⟦7df6faf4:wEaVeRaNtIpOdEaGeNtS:eu-deployment/PostStorageEu→client⟧\n",
	})
	codegen.Register(codegen.Registration{
...
var _ xcweaver.InstanceOf[PostStorageEu] = (*postStorageEu)(nil)
var _ xcweaver.InstanceOf[PostUpload] = (*postUpload)(nil)

// xcweaver.Router checks.
var _ xcweaver.Unrouted = (*app)(nil)
var _ xcweaver.Unrouted = (*notifier)(nil)
var _ xcweaver.Unrouted = (*postStorageEu)(nil)
var _ xcweaver.Unrouted = (*postUpload)(nil)
...
func (s postStorageEu_local_stub) Post(ctx context.Context, a0 string) (r0 []byte, r1 Post_id_obj, err error) {
	// Update metrics.
...
func (s postStorageEu_client_stub) Post(ctx context.Context, a0 string) (r0 []byte, r1 Post_id_obj, err error) {
	// Update metrics.
	var requestBytes, replyBytes int
	begin := s.postMetrics.Begin()
...
func (s postStorageEu_reflect_stub) Post(ctx context.Context, a0 string) (r0 []byte, r1 Post_id_obj, err error) {
